...
class DexHandManipBiHEnv(VecTask):
    ...
    def _reset_default(self, env_ids):
        ...
        self.gym.set_actor_root_state_tensor_indexed(
            ...
            gymtorch.unwrap_tensor(torch.cat([dexhand_multi_env_ids_int32, manip_obj_multi_env_ids_int32])),
            len(torch.cat([dexhand_multi_env_ids_int32, manip_obj_multi_env_ids_int32])),
        )
